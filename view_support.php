            ...
            <div class="single-blog-area ptb100 fix">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-12 col-sm-11" style='padding-bottom:50px;'>
                            <div class="single-blog-body">
                                ...
                                <div class="Leave-your-thought mt50 custom-ulli">
                                    ...
                                    if ($ticket) {
                                        ...
                                        echo "<ul style='display: block;      padding: 20px;
                                        width: 200px;
                                        border: 1px solid;       '>";
                                    ...
                                    ?>
                                      <div class="response">
                                        ...
                                        <form name="ticket" method="post" style='display:flex;height:30px'>
                                                ...
                                                <input type="hidden" value=" " placeholder="Subject" class="info" name="subject">
                                                    ...
                                                    <textarea type="text" placeholder="Message" name="message" id="message" cols="50" rows="5" ></textarea>
                                               
                                       
                                            
                                       
                                              
                                                    <input type="submit" value="Submit" id="update" name="submit" class="btn btn-primary">
