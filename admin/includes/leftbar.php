 ...
 <li>
                        ...
                        <li>
                            <a href="add_city.php"><i class="fa fa-users"></i> Add city</a>
                        </li>
                        ...
                        <li>
                            <a href="#"><i class="fa fa-support"></i> Manage Support<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                       ...
                       <li>
                        ...
                        <li>
                            <a href="#"><i class="fa fa-wrench fa-fw"></i> Venu<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="venu_price.php">Venu Price </a>
                                </li>
                                <li>
                                    <a href="manage_venu.php">Manage Venu</a>
                                </li>
                                <li>
                                    <a href="all_created_venu.php">All Created Venu</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
