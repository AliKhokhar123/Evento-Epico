                                ...
                                <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST" enctype="multipart/form-data">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            <label for="description">Descrieption</label>
                                            <input type="text" name="description" required class="form-control" id="description" placeholder="Venue Description">
                                        </div>
                                        <div class="form-row">
                                        <div class="form-group col-md-4">
    <label for="price">Per Head Pricew</label>
    <input type="number" name="venu_price" required class="form-control" id="price" placeholder="Enter Price" >
</div>
